local MaleModels = {
    "models/humans_sep2025/office_worker.mdl"
}
...
function ENT:CustomOnInitialize()
    ...
    local SpawnWithUniqueHat = math.random(1,4) 

    if SpawnWithUniqueHat == 4 then 
        self:SetBodygroup(bgHelmet, math.random(1, self:GetBodygroupCount(bgHelmet) - 1))
    end
